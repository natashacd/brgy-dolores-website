<template>
  <div class="min-h-full bg-[#f5f6fa] p-4 sm:p-6 lg:p-8" style="font-family: 'Inter', sans-serif;">
      ...
      <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        <div class="flex items-center gap-3">
          ...
          <div>
            ...
            <p class="text-xs text-slate-500 mt-0.5 hidden sm:block">View resident information</p>
          </div>
        </div>
        <button
          v-if="userRole === 'admin'"
    ...
    <!-- Modals -->
    <AddResidentModal v-if="showAddModal && userRole === 'admin'" :roles="roles" @close="showAddModal = false" @saved="handleResidentAdded"/>
    <EditResidentModal v-if="showEditModal && selectedResident && userRole === 'admin'" :resident="selectedResident" :roles="roles" @close="showEditModal = false" @saved="handleResidentUpdated"/>
    <ViewResidentModal
