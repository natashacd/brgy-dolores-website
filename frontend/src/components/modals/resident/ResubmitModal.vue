    ...
    <div class="bg-white rounded-2xl w-full max-w-2xl shadow-2xl overflow-hidden">
      ...
      <div class="px-6 py-5 max-h-[70vh] overflow-y-auto scrollbar-thin">
        <form @submit.prevent="submit" class="space-y-5">
          ...
          <div class="bg-slate-50 rounded-xl p-4">
            ...
            <p class="text-sm text-slate-700"><span class="font-medium">Service:</span> {{ request?.service_type }}</p>
          ...
          <div class="flex flex-col gap-1.5">
            ...
            <input type="text" :value="request?.service_type" readonly
            ...
            <div class="w-full border-2 border-dashed border-[#3d4f7c]/30 rounded-xl p-4 bg-[#3d4f7c]/5 flex flex-col items-center justify-center text-center transition-all hover:border-[#3d4f7c]/50 hover:bg-[#3d4f7c]/10">
              ...
              <template v-if="form.imagePreview">
                <div class="relative w-full max-w-xs mx-auto">
                  <img :src="form.imagePreview" class="w-full h-auto rounded-lg shadow-md" alt="Preview" />
          ...
          <div class="flex items-start gap-3 pt-2">
            ...
            />
            <label for="confirm-checkbox" class="text-xs text-slate-600">
      ...
      <div class="px-6 py-4 border-t border-slate-100 bg-slate-50/60 flex items-center justify-end gap-2">
        ...
        <button @click="submit" :disabled="submitting"
          class="px-5 py-2 text-sm font-semibold text-white bg-amber-600 rounded-xl hover:bg-amber-700 transition-all flex items-center gap-2 disabled:opacity-60">
...
// Form data
const form = ref({
  service_type: props.request?.service_type || '',
  preferred_date: '',
  notes: '',
  confirmed: false,
  imageFile: null,
...
const validateForm = () => {
  ...
  if (!form.value.imageFile) newErrors.image = 'Supporting document/photo is required';
...
const submit = () => {
  ...
  formData.append('preferred_date', form.value.preferred_date);
  formData.append('notes', form.value.notes || '');
  formData.append('document', form.value.imageFile);
  formData.append('original_request_id', props.request.id);
