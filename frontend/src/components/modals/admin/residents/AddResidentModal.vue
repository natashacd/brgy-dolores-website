      ...
      <div class="px-4 sm:px-6 pt-4 sm:pt-5 pb-0 flex-shrink-0 bg-white">
        <div class="flex items-center justify-between mb-3 sm:mb-5">
          <div class="min-w-0 flex-1 pr-2">
            <h2 class="text-sm sm:text-base font-bold text-slate-800 truncate">Add New Resident</h2>
      ...
      <div class="px-3 sm:px-6 py-3 sm:py-5 overflow-y-auto flex-1 scrollbar-thin">
          ...
          <div class="flex flex-col gap-2 sm:gap-3">
            ...
            <div class="w-full border-2 border-dashed border-[#3d4f7c]/30 rounded-xl p-4 sm:p-6 bg-[#3d4f7c]/5 flex flex-col items-center justify-center text-center transition-all hover:border-[#3d4f7c]/50 hover:bg-[#3d4f7c]/10 cursor-pointer" @click="triggerFileInput">
              ...
              <template v-else>
                ...
                <p class="text-xs sm:text-sm font-medium text-slate-700 mb-1">Click to upload</p>
        ...
        <div v-if="currentStep === 2" class="space-y-3 sm:space-y-4">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-3">
            <div class="flex flex-col gap-1">
              ...
              <span v-if="errors.first_name" class="text-[9px] sm:text-[10px] text-red-400">{{ errors.first_name }}</span>
            </div>
            <div class="flex flex-col gap-1">
            ...
            <div class="flex flex-col gap-1">
              ...
              <span v-if="errors.last_name" class="text-[9px] sm:text-[10px] text-red-400">{{ errors.last_name }}</span>
            </div>
            <div class="flex flex-col gap-1">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2 sm:gap-3">
            <div class="flex flex-col gap-1">
              ...
              <span v-if="errors.email" class="text-[9px] sm:text-[10px] text-red-400">{{ errors.email }}</span>
            </div>
            <div class="flex flex-col gap-1">
              ...
              <span v-if="errors.contact_number" class="text-[9px] sm:text-[10px] text-red-400">{{ errors.contact_number }}</span>
            </div>
            <div class="flex flex-col gap-1">
              ...
              <span v-if="errors.sex" class="text-[9px] sm:text-[10px] text-red-400">{{ errors.sex }}</span>
            </div>
          </div>
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2 sm:gap-3">
            <div class="flex flex-col gap-1">
              ...
              <span v-if="errors.birth_place" class="text-[9px] sm:text-[10px] text-red-400">{{ errors.birth_place }}</span>
            </div>
            <div class="flex flex-col gap-1">
              ...
              <span v-if="errors.birth_date" class="text-[9px] sm:text-[10px] text-red-400">{{ errors.birth_date }}</span>
            </div>
            <div class="flex flex-col gap-1">
              ...
              <span v-if="errors.civil_status" class="text-[9px] sm:text-[10px] text-red-400">{{ errors.civil_status }}</span>
            </div>
          </div>
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-2 sm:gap-3">
            ...
            <div class="flex flex-col gap-1">
              ...
              <span v-if="errors.nationality" class="text-[9px] sm:text-[10px] text-red-400">{{ errors.nationality }}</span>
            </div>
            <div class="flex flex-col gap-1">
        ...
        <div v-if="currentStep === 3" class="space-y-3 sm:space-y-4">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2 sm:gap-3">
            <div class="flex flex-col gap-1">
              ...
              <span v-if="errors.emergency_contact_person" class="text-[9px] sm:text-[10px] text-red-400">{{ errors.emergency_contact_person }}</span>
            </div>
            <div class="flex flex-col gap-1">
              <label class="text-[10px] sm:text-xs font-semibold text-slate-600">Contact Number <span class="text-red-400">*</span></label>
              ...
              <span v-if="errors.emergency_contact_number" class="text-[9px] sm:text-[10px] text-red-400">{{ errors.emergency_contact_number }}</span>
            </div>
            <div class="flex flex-col gap-1">
              ...
              <span v-if="errors.emergency_contact_relationship" class="text-[9px] sm:text-[10px] text-red-400">{{ errors.emergency_contact_relationship }}</span>
            </div>
          </div>
        </div>
        ...
        <div v-if="currentStep === 4" class="space-y-3 sm:space-y-4">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2 sm:gap-3">
            <div class="flex flex-col gap-1">
              ...
              <span v-if="errors.house_no" class="text-[9px] sm:text-[10px] text-red-400">{{ errors.house_no }}</span>
            </div>
            <div class="flex flex-col gap-1">
            ...
            <div class="flex flex-col gap-1">
              ...
              <span v-if="errors.sitio" class="text-[9px] sm:text-[10px] text-red-400">{{ errors.sitio }}</span>
            </div>
          </div>
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3">
            <div class="flex flex-col gap-1">
              ...
              <span v-if="errors.latitude" class="text-[9px] sm:text-[10px] text-red-400">{{ errors.latitude }}</span>
            </div>
            <div class="flex flex-col gap-1">
              ...
              <span v-if="errors.longitude" class="text-[9px] sm:text-[10px] text-red-400">{{ errors.longitude }}</span>
            </div>
          </div>
        </div>
        ...
        <div v-if="currentStep === 5" class="space-y-3 sm:space-y-4">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3">
            ...
            <div class="flex flex-col gap-1">
              ...
              <input type="text" value="adminadmin" disabled
                class="border border-slate-200 bg-slate-100 text-slate-400 rounded-xl px-2 py-2 sm:px-3 sm:py-2 text-xs sm:text-sm cursor-not-allowed"/>
              <span class="text-[9px] sm:text-[10px] text-slate-400">Temporary default password</span>
            </div>
          </div>

          <!-- Summary card with image - Responsive -->
          <div class="mt-2 p-3 sm:p-4 bg-[#3d4f7c]/5 border border-[#3d4f7c]/15 rounded-xl">
            ...
            <div v-if="imagePreview" class="mb-2 sm:mb-3 flex justify-center">
              <img :src="imagePreview" class="w-16 h-16 sm:w-20 sm:h-20 rounded-lg object-cover shadow-sm border border-slate-200" alt="Profile preview" />
            </div>
      ...
      <div class="flex items-center justify-between px-3 sm:px-6 py-2 sm:py-4 border-t border-slate-100 bg-slate-50/60 flex-shrink-0">
        ...
        <div class="flex items-center gap-1 sm:gap-2">
          ...
          >
            ...
            <span class="hidden sm:inline">{{ loading ? 'Saving...' : 'Add Resident' }}</span>
          </button>
        </div>
      </div>
