    ...
    <div class="bg-white rounded-2xl w-full max-w-7xl shadow-2xl overflow-hidden max-h-[90vh] flex flex-col">
      ...
      <div class="flex items-center justify-between px-6 py-4 border-b border-slate-100 flex-shrink-0">
        <div class="flex items-center gap-3">
          ...
          <div>
            <h2 class="text-base font-semibold text-slate-800">Add Resident</h2>
            <p class="text-xs text-slate-400 mt-0.5">Fill in the details to register a new resident</p>
          </div>
        </div>
        <button
        ...
        <section>
          ...
          <div class="grid grid-cols-2 gap-3">
            ...
            <div class="flex flex-col gap-1.5">
              ...
              <span class="text-xs text-slate-400">Temporary default password</span>
            </div>
          </div>
        </section>
      </div>
...
const form = ref({
  ...
  house_no: "", purok: "", sitio: "", latitude: "", longitude: "", role_id: "",
});
