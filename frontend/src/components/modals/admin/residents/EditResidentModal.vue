    ...
    <div class="bg-white rounded-2xl w-full max-w-5xl shadow-2xl overflow-hidden max-h-[90vh] flex flex-col">
      ...
      <div class="px-6 pt-5 pb-0 flex-shrink-0 bg-white">
        <div class="flex items-center justify-between mb-5">
          <div>
            <h2 class="text-base font-bold text-slate-800">Edit Resident</h2>
        ...
        <div class="flex items-center gap-2 mb-4">
          ...
          <div class="flex items-center gap-2 text-sm">
            <span class="font-medium text-slate-600">Editing:</span>
            <span class="font-bold text-[#3d4f7c]">{{ fullName }}</span>
            <span class="text-xs text-slate-400">(ID: {{ props.resident.id }})</span>
          </div>
        </div>
        ...
        <div v-if="currentStep === 5" class="space-y-4">
          ...
          <div class="grid grid-cols-2 gap-3">
            ...
            <div class="flex flex-col gap-1.5">
              ...
              <span class="text-[10px] text-slate-400">Resets password to default (adminadmin)</span>
            </div>
          </div>
          ...
          <div class="mt-4 p-4 bg-[#3d4f7c]/5 border border-[#3d4f7c]/15 rounded-xl">
            ...
            <div v-if="imagePreview || currentImage" class="mb-3 flex justify-center">
              <img :src="imagePreview || currentImage" class="w-20 h-20 rounded-lg object-cover shadow-sm border border-slate-200" alt="Profile preview" />
            </div>
            ...
            <div class="grid grid-cols-2 gap-x-6 gap-y-1.5 text-xs">
              ...
              <div class="flex justify-between">
                ...
                <span class="font-semibold" :class="form.status === 1 ? 'text-emerald-600' : 'text-amber-600'">
