<template>
  ...
  <aside
    ...
    :class="[
      ...
      // On desktop: always visible, collapse state controlled by isCollapsed
      isDesktop ? (isCollapsed ? 'lg:w-20' : 'lg:w-72') : (isOpen ? 'translate-x-0' : '-translate-x-full'),
      { 'w-72': !isDesktop } // Fixed width on mobile
    ]"
  >
    ...
    <nav class="flex-1 overflow-y-auto py-6 px-3 space-y-6 scrollbar-thin">
      <!-- Main Section (hide text when collapsed on desktop) -->
      <div>
        <p v-if="!isCollapsed || !isDesktop" class="text-xs font-semibold text-gray-400 uppercase tracking-wider px-3 mb-3" :class="{ 'hidden lg:block': isCollapsed && isDesktop }">MAIN</p>
        <ul class="space-y-1">
          <li>
            <router-link
              to="/admin"
              ...
              :title="isCollapsed && isDesktop ? 'Dashboard' : ''"
              @click="closeMobileSidebar"
            >
              <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
              </svg>
              <span v-if="!isCollapsed || !isDesktop" :class="{ 'hidden lg:block': isCollapsed && isDesktop }">Dashboard</span>
            </router-link>
          </li>
          <li>
            <router-link
              ...
              :title="isCollapsed && isDesktop ? 'Barangay Officials' : ''"
              @click="closeMobileSidebar"
            >
              <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
              </svg>
              <span v-if="!isCollapsed || !isDesktop" :class="{ 'hidden lg:block': isCollapsed && isDesktop }">Barangay Officials</span>
            </router-link>
          </li>
        </ul>
      </div>
      ...
      <!-- Management Section -->
      <div>
        <p v-if="!isCollapsed || !isDesktop" class="text-xs font-semibold text-gray-400 uppercase tracking-wider px-3 mb-3" :class="{ 'hidden lg:block': isCollapsed && isDesktop }">MANAGEMENT</p>
        <ul class="space-y-1">
          <li>
            <router-link
              to="/admin/residents"
              ...
              :title="isCollapsed && isDesktop ? 'Resident Management' : ''"
              @click="closeMobileSidebar"
            >
              <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
              </svg>
              <span v-if="!isCollapsed || !isDesktop" :class="{ 'hidden lg:block': isCollapsed && isDesktop }">Resident Management</span>
            </router-link>
          </li>
          <li>
            <router-link
              ...
              :title="isCollapsed && isDesktop ? 'Service Requests' : ''"
              @click="closeMobileSidebar"
            >
              <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <span v-if="!isCollapsed || !isDesktop" :class="{ 'hidden lg:block': isCollapsed && isDesktop }">Service Requests</span>
            </router-link>
          </li>
          <li>
            <router-link
              ...
              :title="isCollapsed && isDesktop ? 'Document Approval' : ''"
              @click="closeMobileSidebar"
            >
              <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
              </svg>
              <span v-if="!isCollapsed || !isDesktop" :class="{ 'hidden lg:block': isCollapsed && isDesktop }">Document Approval</span>
            </router-link>
          </li>
          <li>
            <router-link
              ...
              :title="isCollapsed && isDesktop ? 'Complaints & Disputes' : ''"
              @click="closeMobileSidebar"
            >
              <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
              <span v-if="!isCollapsed || !isDesktop" :class="{ 'hidden lg:block': isCollapsed && isDesktop }">Complaints & Disputes</span>
            </router-link>
          </li>
          <li>
            <router-link
              ...
              :title="isCollapsed && isDesktop ? 'Reports & Analytics' : ''"
              @click="closeMobileSidebar"
            >
              <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
              </svg>
              <span v-if="!isCollapsed || !isDesktop" :class="{ 'hidden lg:block': isCollapsed && isDesktop }">Reports & Analytics</span>
            </router-link>
          </li>
        </ul>
      </div>
      ...
      <!-- Content Section -->
      <div>
        <p v-if="!isCollapsed || !isDesktop" class="text-xs font-semibold text-gray-400 uppercase tracking-wider px-3 mb-3" :class="{ 'hidden lg:block': isCollapsed && isDesktop }">CONTENT</p>
        <ul class="space-y-1">
          <li>
            <router-link
              ...
              :title="isCollapsed && isDesktop ? 'Announcements' : ''"
              @click="closeMobileSidebar"
            >
              <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <span v-if="!isCollapsed || !isDesktop" :class="{ 'hidden lg:block': isCollapsed && isDesktop }">Announcements</span>
            </router-link>
          </li>
          <li>
            <router-link
              ...
              :title="isCollapsed && isDesktop ? 'Settings' : ''"
              @click="closeMobileSidebar"
            >
              <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <span v-if="!isCollapsed || !isDesktop" :class="{ 'hidden lg:block': isCollapsed && isDesktop }">Settings</span>
            </router-link>
          </li>
        </ul>
      </div>
    ...
    <div class="p-3 border-t border-[#2a2f3f]">
      ...
      >
        ...
        <span v-if="!isCollapsed || !isDesktop" :class="{ 'hidden lg:block': isCollapsed && isDesktop }">Logout</span>
      </button>
    </div>
  </aside>
</template>
